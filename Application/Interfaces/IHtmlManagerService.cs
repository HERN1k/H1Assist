...
namespace Application.Interfaces
{
    ...
    {
        Task<IDocument> GetDocumentAsync(string url, bool useCache = true);
        ...
        Task<CleanDescriptionHtmlDto> CleanDescriptionHtmlAsync(IElement descriptionElement, ExternalService service, string? newMediaFolderPath = "");
    }
}